...
(function() {
 ...
 loadPackage({
  "files": [ {
   "filename": "/shader/flat.vert",
   "start": 0,
   "end": 244
  }, {
   "filename": "/shader/lambert.vert.glsl",
   "start": 244,
   "end": 2993
  }, {
   "filename": "/shader/.DS_Store",
   "start": 2993,
   "end": 9141
  }, {
  ...
  "package_uuid": "1513494b-b390-4dba-ace8-12f40623d4a2"
 });
})();
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var pthreadMainJs = locateFile("WebCraft.worker.js");
...
function _emscripten_get_preloaded_image_data(path, w, h) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(31, 1, path, w, h);
...
function _emscripten_get_preloaded_image_data_from_FILE(file, w, h) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(32, 1, file, w, h);
